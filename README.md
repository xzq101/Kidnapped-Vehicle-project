...
I installed Ubuntu in Windows 10 Bash. In Ubuntu system create a clone version of the startup code for this project. Run the three command above, the built code can communicate with the simulater running under windows.
